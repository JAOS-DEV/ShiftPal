...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    ...
    <path d="M8.25 19.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0z" />
    <path d="M15.75 6.375c0-1.036.84-1.875 1.875-1.875h.375a3 3 0 013 3v6.375h-1.5V6.375c0-1.036-.84-1.875-1.875-1.875h-.375a1.875 1.875 0 00-1.875 1.875v6.375h-1.5V6.375z" />
  </svg>
);
